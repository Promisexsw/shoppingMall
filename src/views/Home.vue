<template>
  <div id="home" class="home">
    <van-search input-align='center' v-model="searchData"  placeholder="商品搜索，共239万款好物" />
    <!-- <HelloWorld msg="Welcome to Your Vue.js App"/> -->
    <van-swipe :autoplay="3000" lazy-render width='375' height="200">
       <van-swipe-item v-for="(image,index) in images" :key="index">
       <img class="swiperimg" :src="image.image_url" />
        </van-swipe-item>
    </van-swipe>
    <!-- 5个图标 -->
...
export default {
  ...
  async mounted() {
  let res = axios.get(api.IndexUrl)
